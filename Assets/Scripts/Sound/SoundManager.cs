...
public class SoundManager : ManualSingletonMono<SoundManager>
    {
        ...
        private Dictionary<int, Audio> audioPool = new Dictionary<int, Audio>();
        ...
        {
            if (PlayerDatas.PlayerData.Instance.PlayerMapInfo.GetCurrentMap().Level == 99)
            {
                StopAllMusic();
                PlayMusic(SoundPalette.Instance.GetBackGroundMusic(AudioClipType.BackGroundZone1MapBoss), 1f, true, false);
            }
            else
            {
                StopAllMusic();
                PlayMusic(SoundPalette.Instance.GetBackGroundMusic(AudioClipType.BackGroundZone1), 1f, true, true);
            }
        ...
        private void UnPauseAllAudio(Audio.AudioType audioType)
        {
            Dictionary<int, Audio> audioDict = GetAudioTypeDictionary(audioType);
