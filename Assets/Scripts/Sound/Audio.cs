        ...
        public class Audio
        {
            ...
            public void Update()
            {
                ...
                switch (Type)
                {
                    ...
                    {
                        AudioSource.volume = Volume * SoundManager.Instance.GlobalMusicVolume *
                                             SoundManager.Instance.GlobalVolume;
                        break;
                    }

                    case AudioType.Sound:
                    {
                        AudioSource.volume = Volume * SoundManager.Instance.GlobalSoundsVolume *
                                             SoundManager.Instance.GlobalVolume;
                        break;
                    }
                    ...
                    {
                        AudioSource.volume = Volume * SoundManager.Instance.GlobalUISoundsVolume *
                                             SoundManager.Instance.GlobalVolume;
                        break;
                    }
                }
