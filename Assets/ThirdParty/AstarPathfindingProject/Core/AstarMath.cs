...
namespace Pathfinding {
	...
	public static class AstarSplines {
		public static Vector3 CatmullRom (Vector3 previous, Vector3 start, Vector3 end, Vector3 next, float elapsedTime) {
			...
			// https://local.wasp.uwa.edu.au/~pbourke/miscellaneous/interpolation/
	...
	public static class VectorMath {
		...
		/// \author Slightly modified code from https://www.3dkingdoms.com/weekly/weekly.php?a=21
		/// </summary>
	...
	public static class AstarMath {
		...
		/// According to the algorithm described at https://en.wikipedia.org/wiki/HSL_and_HSV
		///
		/// @author Wikipedia
	...
	public static class Polygon {
		...
		/// \author https://unifycommunity.com/wiki/index.php?title=PolyContainsPoint (Eric5h5)
		/// </summary>
