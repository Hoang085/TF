...
namespace Bayat.SaveSystem
{
    ...
    public class WelcomeWindow : EditorWindowWrapper
    {
        ...
        public override void OnGUI()
        {
            ...
            {
                Application.OpenURL("https://docs.bayat.io/save-system/packages/demos.unitypackage");
            }
            EditorGUILayout.EndHorizontal();
            ...
            {
                Application.OpenURL("https://docs.bayat.io/save-system/manual");
            }
            EditorGUILayout.EndHorizontal();
            ...
            if (GUILayout.Button("Learn More"))
            {
                Application.OpenURL("https://docs.bayat.io/save-system/api");
            }
            EditorGUILayout.EndHorizontal();
            ...
            if (GUILayout.Button("Learn More"))
            {
                Application.OpenURL("https://docs.bayat.io/save-system/manual/integrations");
            }
            EditorGUILayout.EndHorizontal();
